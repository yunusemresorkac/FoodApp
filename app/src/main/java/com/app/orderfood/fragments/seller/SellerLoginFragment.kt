...
import com.app.orderfood.databinding.FragmentSellerLoginBinding
...
class SellerLoginFragment : Fragment() {
    ...
    private lateinit var binding : FragmentSellerLoginBinding
            ...
            CoroutineScope(Dispatchers.IO).launch {
                try {
                    ...
                    val myUser = withContext(Dispatchers.IO) {
                        firestore.collection("Sellers").document(user!!.uid)
